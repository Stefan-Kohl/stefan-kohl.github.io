...
[ "{COUNTER}",
   Concatenation( "<!-- Web-Counter START -->\n",
                  ...
                  "<!-- Web-Counter ENDE -->" ) ],
[ "{DOWNLOADCOUNTER}",
  "http://www.web-counter-service.de/counter/dlcount.php?id=stefan.kohl.vlore&url=/" ],
[ "{BACK}",
  Concatenation( "<table class = \"footer\" width = \"100%\" cellspacing = \"1\" cellpadding = \"2\"\n",
                 ...
                 "  <tr> <td> Back to <a class = \"footer\" href = \"http://www.gap-system.org/DevelopersPages/StefanKohl/\" target = \"_parent\">main page</a> </td>\n",
                 "  </tr>\n</table>" ) ],
